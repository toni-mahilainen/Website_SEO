...
class Footer extends Component {
    componentDidMount() {
        ...
        if (screenwidth < 992) {
            ...
            let wrapper = document.getElementById("flexWrapper");

            for (let index = 0; index < hiddens.length; index++) {
                hiddens[index].classList.remove("hidden");
                hiddens[index].classList.add("visibleNoAnimation");
            }

            wrapper.classList.add("flexFooterWrapper");
        }
                            ...
                            <Container bsPrefix="openInfoContainer footerHidden">
                                <Row>
                                    <Col>
                                        <h5>SEO Koski</h5>
                                        <ul>
                                            <li className="daysBigScreen">Maanantai - Perjantai</li>
                                            <li className="daysSmallScreen">Ma - Pe</li>
                                            <li className="listTimes">06.00 - 19.00</li>
                                            <li className="daysBigScreen">Lauantai</li>
                                            <li className="daysSmallScreen">La</li>
                                            <li className="listTimes">08.00 - 16.00</li>
                                            <li className="daysBigScreen">Sunnuntai</li>
                                            <li className="daysSmallScreen">Su</li>
